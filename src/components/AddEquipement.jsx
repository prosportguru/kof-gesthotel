...
export default function AddEquipement({close,load_data,selected}) {
    ...
    const valider=async ()=>{
       ...
       if(selected==null){
            ...
            await db.collection("equipements").add(line)
       }else{
        await db.collection("equipements").doc(selected?.key).update(line,{merge:true})
       }
